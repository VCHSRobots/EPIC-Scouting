...
func TouchBase(databasePath string) {
	...
	users.Exec("CREATE TABLE IF NOT EXISTS users ( userid TEXT PRIMARY KEY UNIQUE NOT NULL, username TEXT NOT NULL UNIQUE, password TEXT NOT NULL, team TEXT, firstname TEXT, lastname TEXT, email TEXT UNIQUE, phone TEXT UNIQUE, usertype TEXT)") // TODO: Add support for N+ contact options; via linked table?
	...
	campaigns.Exec("CREATE TABLE IF NOT EXISTS events ( eventid TEXT PRIMARY KEY NOT NULL, campaignid TEXT NOT NULL, name TEXT NOT NULL, location TEXT, starttime TEXT, endtime TEXT )") // TODO: Add more information about each event.
	campaigns.Exec("CREATE TABLE IF NOT EXISTS matches ( matchid TEXT PRIMARY KEY NOT NULL, eventid TEXT NOT NULL, matchnumber INTEGER NOT NULL, starttime TEXT, endtime TEXT )")        // TODO: Add more information about each match.
	campaigns.Exec("CREATE TABLE IF NOT EXISTS participants (matchid TEXT PRIMARY KEY NOT NULL, competitorid TEXT NOT NULL) ")                                                           // The participants in each match.
